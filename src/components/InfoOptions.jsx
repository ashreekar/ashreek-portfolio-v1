function InfoOptions({ option, setOption }) {
  const selectedClass =
    "h-full w-1/3 text-center p-1 rounded-md font-semibold cursor-pointer " +
    "bg-white text-gray-900 shadow-md " +
    "dark:bg-neutral-800 dark:text-gray-100";

  const unselectedClass =
    "h-full w-1/3 text-center p-1 font-semibold cursor-pointer transition " +
  ...
  return (
    <div className="flex p-1 rounded-md gap-2 bg-gray-100 dark:bg-neutral-900">
      ...
      <p
        className={option === "skills" ? selectedClass : unselectedClass}
